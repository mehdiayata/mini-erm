 ...
 */
final class Version20211119132512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, provider_id INT DEFAULT NULL, company_id INT DEFAULT NULL, transaction_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, price NUMERIC(12, 2) NOT NULL, tax NUMERIC(5, 2) NOT NULL, stock INT NOT NULL, INDEX IDX_D34A04ADA53A8AA (provider_id), INDEX IDX_D34A04AD979B1AD6 (company_id), UNIQUE INDEX UNIQ_D34A04AD2FC0CB0F (transaction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
